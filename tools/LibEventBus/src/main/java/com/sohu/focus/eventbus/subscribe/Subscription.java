...
public class Subscription {
     ...
     * @param event        感兴趣的事件
     */
    public Subscription(Object subscriber, Method method,ThreadMode mode,EventType event) {
         this(subscriber, method, mode, event,0);
    }
     ...
     * @param p      优先级
     */
    public Subscription(Object sub, Method method,ThreadMode mode,EventType event,int p) {
        subscriber = new WeakReference<Object>(sub);
        targetMethod = method;
        threadMode = mode;
        eventType = event;
        priority = p;
