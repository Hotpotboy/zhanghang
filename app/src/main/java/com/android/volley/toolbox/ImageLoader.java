...
public class ImageLoader {
    ...
    /** Amount of time to wait after first response arrives before delivering all responses. 第一个响应达到之后，到传递所有响应之前，需要等待多少秒*/
     ...
     * 包含所有与图片请求相关的数据，主要有四种：成功加载的图片，加载成功（失败）的监听器，
     * 图片请求的缓存key，图片请求的URL
     */
                    ...
                    for (BatchedImageRequest bir : mBatchedResponses.values()) {
                        for (ImageContainer container : bir.mContainers) {
                            ...
                            if (bir.getError() == null) {
                                ...
                                container.mListener.onResponse(container, false);//回调响应方法！
                            } else {
